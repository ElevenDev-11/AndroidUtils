...
// ================================== 请求相关 ==================================
    ...
    public static void post(final String api, final Map<String, String> params, final HttpCallback callback) {
        HttpUtil.post(api, params, callback);
    }
